...
def runBGP(routers):
    routers['r1'].cmd('zebra -f zebra.conf -d -i /var/run/quagga/zebrar1.pid')
    routers['r1'].cmd('bgpd -f bgp_r1.conf -d -i /var/run/quagga/bgpdr1.pid')
    routers['r2'].cmd('zebra -f zebra.conf -d -i /var/run/quagga/zebrar2.pid')
    routers['r2'].cmd('bgpd -f bgp_r2.conf -d -i /var/run/quagga/bgpdr2.pid')
    routers['r3'].cmd('zebra -f zebra.conf -d -i /var/run/quagga/zebrar3.pid')
    routers['r3'].cmd('bgpd -f bgp_r3.conf -d -i /var/run/quagga/bgpdr3.pid')
    routers['r4'].cmd('zebra -f zebra.conf -d -i /var/run/quagga/zebrar4.pid')
    routers['r4'].cmd('bgpd -f bgp_r4.conf -d -i /var/run/quagga/bgpdr4.pid')
